...
$sql = "SELECT * FROM covoiturage where dep='$de' and arr='$a' and date_p='$date' ORDER BY id DESC LIMIT 5";
...
<div class="cart" >
    ...
    <div class="places">
        ...
        <button style="background-color:#ff1c37 ;" ><a style="text-decoration: none; color: #ffffff;" href="profile.php?page=7&id_pub=<?php echo $row['id'];?>">Reserver</a></button>
    </div>
</div>
